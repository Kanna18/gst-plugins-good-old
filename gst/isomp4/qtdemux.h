...
//gboolean qtdemux_parse_moov (GstQTDemux * qtdemux, const guint8 * buffer, gint length);
gboolean
...
GstFlowReturn qtdemux_expose_streams (GstQTDemux * qtdemux);
GstFlowReturn qtdemux_prepare_streams (GstQTDemux * qtdemux);
GstFlowReturn
...
GstFlowReturn
gst_mmtdemux_state_movie (GstQTDemux * qtdemux, GstBuffer *buf, guint64 offset, int mediaType, gint32 sample_number);
GstFlowReturn
gst_qtdemux_pull_atom (GstQTDemux * qtdemux, guint64 offset, guint64 size,
    GstBuffer ** buf);


//unsigned int ParseMMTPHDR(GstQTDemux * qtdemux, unsigned char* Bitstream);
